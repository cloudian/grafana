...
export const cardStyle = stylesFactory((theme: GrafanaTheme, complete: boolean) => {
  ...
  const darkThemeGradients = complete ? completeGradient : 'linear-gradient(to right, #c1d500 0%, #fbca0a 100%)';
  const lightThemeGradients = complete ? completeGradient : 'linear-gradient(to right, #FBCA0A 0%, #c1d500 100%)';
