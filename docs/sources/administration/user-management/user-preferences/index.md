...
If your Grafana instance uses an external authentication provider, then you might not be able to change your password in Grafana. Contact your LogInsight administrator for more information.
{{% /admonition %}}
