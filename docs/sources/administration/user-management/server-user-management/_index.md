...
This indicates whether the user account has the LogInsight administrator flag applied. If the flag is set to **Yes**, then the user is a Grafana server administrator.
