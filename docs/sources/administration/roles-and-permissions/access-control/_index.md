...
{{% admonition type="note" %}}
You cannot use a service account to modify basic roles via the RBAC API. To update basic roles, you must be a LogInsight administrator and use basic authentication with the request.
{{% /admonition %}}
